...
const { getVideogamesHandler, postVideogameHandler, getVideogameByIdHandler,getVideogamesByNameHandler } = require('../handlers/videogamesHandlers.js');
...
// videogameRouter.get("/name", prueba);
